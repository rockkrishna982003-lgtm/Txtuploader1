...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8722180281:AAEFG5aVXBnc-4fEwXq1rnxxVPX9pKEc9Gs")

CREDIT = os.environ.get("CREDIT", "𝐈𝐓'𝐬𝐆𝐎𝐋𝐔")
# MongoDB Configuration
DATABASE_NAME = os.environ.get("DATABASE_NAME", "CpprivateApi")
DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://rockkrishna982003_db_user:9PHefiq2qEiOZJLu@rockkrishna982.6l048gw.mongodb.net/?appName=CpprivateApi")  # Add your own atlas db
